...
def code_handler(step):
    ...
    if request_input is not None:
        display.new_cell(f"# --- This cell is generated by HAL ---\n# [HAL code] Requesting user input:\n\n{request_input}")
        with output:
            print("[HAL code] Requesting user input. Please run the following cell to provide necessary inputs.")
    def trigger_exec(b):
